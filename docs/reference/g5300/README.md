...
- `ap2_rider_demand.c` realizuje base/dynamic, a `ap2_pas_state.c` odebranie permission. Zachować tę separację. Stock nie dowodzi konieczności przepisania demand jako rider-power ani przeniesienia 6-state torque wprost.
